  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-10 w-32 h-32 bg-[hsl(var(--wellness-green))] rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="h-1 w-16 bg-gradient-to-r from-transparent to-[hsl(var(--wellness-green))] rounded-full"></div>
            <div className="h-1 w-24 bg-gradient-to-r from-[hsl(var(--wellness-green))] to-[hsl(var(--wellness-blue))] rounded-full mx-2"></div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-3xl shadow-xl p-8 max-w-md mx-auto border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex items-center justify-center mb-6">
              <div className="w-12 h-12 bg-gradient-to-r from-[hsl(var(--wellness-green))] to-green-600 rounded-full flex items-center justify-center mr-3 shadow-lg">
            ...
            <a 
              ...
              className="text-[hsl(var(--wellness-green))] hover:text-green-700 text-xl font-semibold transition-colors duration-200 hover:underline flex items-center justify-center group"
            >
