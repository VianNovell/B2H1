...
export default function Programs() {
  ...
  const programs = [
    ...
    },
    {
      ...
      description: (
        <>
          Back 2 Health has designed a course for people with Type II Diabetes and Prediabetes to aid in a greater understanding of your diabetes status and give you the <span className="text-blue-800 font-bold">tools to be as healthy as possible</span>. The course aims to provide patients with a good foundation and practical skills to begin self-management of their diabetes. It empowers them to self-manage by providing a working understanding of their illness and through addressing issues around the initiation and sustaining of motivation. It is also useful as a <span className="text-blue-800 font-bold">weight loss program for those suffering from obesity</span>. The program may aid in reduction of cholesterol levels. <span className="text-blue-800 font-bold">Ultimately the course will improve overall health parameters for the majority</span>.
        </>
      ),
      features: [],
          ...
          <div className="text-center mt-12 md:mt-20">
            <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl max-w-4xl mx-auto">
              ...
              <p className="text-sm md:text-base text-gray-600 mb-6 leading-relaxed px-2">
                Contact us to discuss your wellness goals and find the perfect program
              </p>
              <Button
