...
export default function ServiceDetail() {
  ...
  const serviceData: Record<string, any> = {
    ...
    "pemf-therapy": {
      ...
      fullDescription: "A strong magnetic energy field of electrons is channeled through your body to promote its natural healing process and accelerate recovery through improved micro-circulation and neuro-musculo activation. Back 2 Health (Entebbe) is equipped with modern technology to provide PEMF therapy. After understanding your needs and conditions, our qualified and experienced professionals provide the gentle magnetic pulses for a stipulated time. It often induces a relaxed feeling, such as a massage.\n\nPulsed electromagnetic fields (PEMFs) is a safe and non-invasive technique that works by eliciting a biological tissue and cellular response that repairs the body naturally. PEMF uses Pulsating magnetic fields generated by electromagnets with particular frequencies, waveforms and intensities using specially designed apparatus for therapeutic, rejuvenative or performance enhancement benefits. It improves blood supply and causes an increase in oxygen pressure, activating and regenerating cells.\n\nThis treatment concept is far from new; Academic study of PEMF began as early as 1932 when researchers from Yale University discovered that depleted electrical energy from the body caused dis-ease. However, pulsed electromagnetic fields were able to donate energy, helping cells to repair, rebuild, and regenerate naturally. Used by NASA on astronauts returning from space to regenerate bone and muscle loss.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Safety Information for PEMF Therapy */}
              {slug === 'pemf-therapy' && (
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Who Can Have PEMF Therapy?</h3>
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    PEMF therapy is suitable for adults with multiple conditions. Scientists have observed that a healthy cell has a higher electrical charge than an unhealthy one. This higher charge permits it to function optimally. It has been established that tissues including blood, muscle, ligaments, bone and cartilage and nerves all respond to these biomagnetic fields.
                  </p>
                  ...
                  <div className="bg-red-50 border-l-4 border-red-500 p-6 mb-6">
                    <h4 className="text-xl font-bold text-red-800 mb-3">Important: This Therapy is NOT Suitable if you:</h4>
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6">
                    <h4 className="text-xl font-bold text-yellow-800 mb-3">Please Inform Your Therapist</h4>
