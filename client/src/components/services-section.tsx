...
export default function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      color: "wellness-blue",
      image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300",
    },
    {
      icon: Hand,
